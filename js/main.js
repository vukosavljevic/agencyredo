...
$(function () {
    ...
    ***************************/
    // Check if running on local file system (file://) or web server (http/https)
    let swup;
    if (window.location.protocol !== 'file:') {
        // Only initialize SWUP on web servers, not for local files
        const options = {
        ...
        // For local files, create a dummy swup object to prevent errors
        swup = {
            on: function() {},
            off: function() {},
            destroy: function() {}
        };
        console.log('SWUP disabled for local file system. Will work normally on web server.');
    }
    ...
    ***************************/
    ...
    timeline.fromTo(".mil-reveal-box", 0.8, {
        opacity: 0,
        width: "0%",
        x: "-50px"
    }, {
    ...
    timeline.to(".mil-reveal-box", 0.8, {
        width: "0%",
        ease: "power2.inOut"
    }, "+=.1");
    ...
    ***************************/
    ...
    ------------------------------------------------------------
    ----------------------------------------------------------*/
    // Only add SWUP event listener if SWUP is properly initialized (not running on local files)
    if (window.location.protocol !== 'file:') {
